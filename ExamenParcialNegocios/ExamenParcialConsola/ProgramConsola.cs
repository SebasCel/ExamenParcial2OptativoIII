    ...
    class ProgramConsola
    {
                ...
                while (true)
                {
                    ...
                    switch (opcion)
                    {
                        ...
                        case 13:
                            return;
                        default:
                            Console.WriteLine("Opción no válida. Elija una opción correcta.");
                            break;
                    }
                }
            }
        ...
        static void LeerFactura(FacturaRepository facturaRepository)
        {
            ...
            if (int.TryParse(Console.ReadLine(), out int id))
            {
                ...
                {
                    Console.WriteLine("Error al leer la factura: " + ex.Message);
                }
            }
            else
            {
        ...
        static Factura ObtenerDatosFacturaDesdeConsola()
        {
            ...
            Console.Write("Estado: ");
            factura.Estado = Console.ReadLine();
            return factura;
        }
        ...
        static void LeerSucursal(SucursalRepository sucursalRepository)
        {
            ...
            if (int.TryParse(Console.ReadLine(), out int id))
            {
                ...
                {
                    Console.WriteLine("Error al leer la sucursal: " + ex.Message);
                }
            }
            else
            {
